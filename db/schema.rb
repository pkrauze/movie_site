...
ActiveRecord::Schema.define(version: 20170901111645) do
...
<<<<<<< HEAD
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["director_id"], name: "index_notifications_on_director_id"
...
<<<<<<< HEAD
  ...
  create_table "subscribers", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "genre_id"
    t.index ["director_id"], name: "index_subscribers_on_director_id"
