...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { firstname: @director.firstname, lastname: @director.lastname, year_of_birth: @director.year_of_birth }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { firstname: @director.firstname, lastname: @director.lastname, year_of_birth: @director.year_of_birth }
    assert_redirected_to director_path(assigns(:director))
  end
